...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.1um`

**compared 140 materials (20 without native output); native px 573079, python px 573079, pooled jaccard 1.0000, common-pixel fit exact 1.0000**

| Material | Native | Python | Jaccard | Fit exact | Depth exact | Fit max |
|---|---:|---:|---:|---:|---:|---:|
| `nanohematite.BR34b2b` | 131,357 | 131,357 | 1.000 | 1.000 | 1.000 | 1 |
| `Fe2++goeth+musc` | 85,571 | 85,571 | 1.000 | 1.000 | 1.000 | 0 |
| `generic.Fe2+nrw.cummingtonite` | 60,308 | 60,308 | 1.000 | 1.000 | 1.000 | 1 |
| `hematite-nano+goethite-fg-amix` | 46,030 | 46,030 | 1.000 | 1.000 | 1.000 | 0 |
| `chlor+muscphy` | 45,893 | 45,893 | 1.000 | 1.000 | 1.000 | 1 |
| `fe3+bearing1` | 40,238 | 40,238 | 1.000 | 1.000 | 1.000 | 0 |
| `jarosite-thinfilm-GDS243` | 30,869 | 30,868 | 1.000 | 1.000 | 1.000 | 1 |
...
| `nanohematite.BR34b2` | 12,724 | 12,724 | 1.000 | 1.000 | 1.000 | 0 |
| `hematite.fine.gr.fe2602` | 11,424 | 11,424 | 1.000 | 1.000 | 1.000 | 0 |
...
| `goethite+qtz.medgr.gds240` | 7,575 | 7,575 | 1.000 | 1.000 | 1.000 | 0 |
...
| `goethite.coarsegr.ws222` | 2,646 | 2,646 | 1.000 | 1.000 | 1.000 | 0 |
| `kjarosite200` | 2,338 | 2,338 | 1.000 | 1.000 | 1.000 | 0 |
| `Fe2+_hematite_weathering` | 1,269 | 1,269 | 1.000 | 1.000 | 1.000 | 0 |
| `goethite.medcoarsegr.mpc` | 1,238 | 1,238 | 1.000 | 1.000 | 1.000 | 0 |
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.2um`

### Detail: `aragonite (group 2, carbonate_aragonite)`

```text
native 13168  python 13168  both 13168  jaccard 1.0000
common fit   n=13168 exact=0.9999 max=1
common depth n=9362 exact=1.0000 max=0
```

### Detail: `calcite.ws272.g2 (group 2, carbonate_calcite)`

```text
native 55267  python 55267  both 55267  jaccard 1.0000
common fit   n=55267 exact=1.0000 max=1
common depth n=45457 exact=1.0000 max=0
```
...
| Material | Native | Python | Jaccard | Fit exact | Depth exact | Fit max |
|---|---:|---:|---:|---:|---:|---:|
| `muscovite-medhigh-Al` | 89,694 | 89,695 | 1.000 | 1.000 | 1.000 | 1 |
| `calcite+0.3muscovite` | 66,854 | 66,854 | 1.000 | 1.000 | 1.000 | 0 |
| `beidellite_gds123` | 65,271 | 65,271 | 1.000 | 1.000 | 1.000 | 0 |
| `calcite.ws272.g2` | 55,267 | 55,267 | 1.000 | 1.000 | 1.000 | 1 |
| `kaolgrp_nacrite` | 34,914 | 34,914 | 1.000 | 1.000 | 1.000 | 0 |
| `montna` | 33,649 | 33,649 | 1.000 | 1.000 | 1.000 | 0 |
| `muscovite-med-Al` | 24,865 | 24,864 | 1.000 | 1.000 | 1.000 | 0 |
...
| `muscovite+chlorite` | 5,802 | 5,802 | 1.000 | 1.000 | 1.000 | 1 |
| `kaol.75+alun.25` | 5,582 | 5,581 | 1.000 | 1.000 | 1.000 | 0 |
| `beidellite_gds124` | 4,071 | 4,071 | 1.000 | 1.000 | 1.000 | 0 |
| `sulfate-mix_gypsum.trace.dust+debris-WTC01` | 4,071 | 4,071 | 1.000 | 1.000 | 1.000 | 0 |
| `kaolin.5+smect.5` | 3,836 | 3,836 | 1.000 | 1.000 | 1.000 | 0 |
| `hectorite` | 3,638 | 3,638 | 1.000 | 1.000 | 1.000 | 0 |
...
| `sepiolite` | 1,100 | 1,100 | 1.000 | 1.000 | 1.000 | 0 |
...
| `nontronite.ng-1.a.g2` | 833 | 833 | 1.000 | 0.999 | 1.000 | 1 |
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.veg`

**compared 4 materials (0 without native output); native px 550506, python px 550506, pooled jaccard 1.0000, common-pixel fit exact 1.0000**
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.1.5um-broad`
...
| `microcline_hs103.3b` | 97 | 97 | 1.000 | 1.000 | nan | 0 |
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.2um-broad`
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.ree`

**compared 41 materials (20 without native output); native px 17727, python px 17727, pooled jaccard 1.0000, common-pixel fit exact 0.9986**
...
| `ree_nd_xenotime` | 1,701 | 1,701 | 1.000 | 0.998 | 0.999 | 1 |
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.ree_g21`

**compared 40 materials (20 without native output); native px 17726, python px 17726, pooled jaccard 1.0000, common-pixel fit exact 0.9986**
...
| `ree_nd_xenotime_g21` | 1,701 | 1,701 | 1.000 | 0.998 | 0.998 | 1 |
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.ree_samar`
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.ch4gas-2.3um`
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\group.co2gas-2um`

**compared 29 materials (20 without native output); native px 107050, python px 107050, pooled jaccard 1.0000, common-pixel fit exact 1.0000**
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\case.red-edge`

**compared 2 materials (0 without native output); native px 528969, python px 528969, pooled jaccard 1.0000, common-pixel fit exact 0.9999**

| Material | Native | Python | Jaccard | Fit exact | Depth exact | Fit max |
|---|---:|---:|---:|---:|---:|---:|
| `red.edge.shift.2` | 466,101 | 466,101 | 1.000 | 1.000 | 1.000 | 1 |
| `red.edge.shift.1` | 62,868 | 62,868 | 1.000 | 1.000 | 1.000 | 1 |

## Case 2

`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\case.veg.type`
...
| Material | Native | Python | Jaccard | Fit exact | Depth exact | Fit max |
|---|---:|---:|---:|---:|---:|---:|
| `vegetation.type13` | 465,846 | 465,846 | 1.000 | 1.000 | 1.000 | 1 |
| `vegetation.type6` | 652 | 652 | 1.000 | 1.000 | 1.000 | 0 |
...
**compared 1 materials (0 without native output); native px 432034, python px 432034, pooled jaccard 1.0000, common-pixel fit exact 1.0000**
...
**compared 1 materials (0 without native output); native px 460509, python px 460509, pooled jaccard 1.0000, common-pixel fit exact 1.0000**
...
`\\wsl.localhost\Ubuntu\home\hyperspectral\tetracorder-data\cuprite95\testrun1\case.ep-cal-chl`
